...
include '../../koneksi.php';
$id=$_GET['id'];
$sql = "SELECT * FROM kategori_buku WHERE kategori_id=$id";
...
<div class="container">
    <?php if($result){ 
        $row = mysqli_fetch_assoc($result) ;
          ?>
    <h2>Edit Kategori</h2>
    <form action="../../proses/proses_edit_kategori.php?id=<?= $row['kategori_id']?>" method="POST">
      <div class="form-group">
        <label for="kategori">Nama Kategori:</label>
    <input type="text" id="category-name" name="kategori" value="<?= $row['nama_kategori'] ?>">
      </div>
