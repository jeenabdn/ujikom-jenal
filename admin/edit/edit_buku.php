...
$sql1 = "SELECT buku.*, kategori_buku.nama_kategori FROM buku INNER JOIN kategori_buku ON buku.kategori_id=kategori_buku.kategori_id WHERE buku.buku_id='$id'";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- Books Card Example -->
        <div class="container">
            <form action="../../proses/proses_edit_buku.php?id=<?=$ruw['buku_id'] ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <select class='form-control' name='kategori_id' required>
                        ...
                        <option value="<?= $rew['kategori_id'] ?>"><?= $rew['nama_kategori'] ?></option>
                        <?php endwhile ?>
                    </select>
                </div>
